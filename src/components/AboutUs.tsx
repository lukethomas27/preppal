    ...
    <div className="w-full">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <p className="text-gray-600 mb-4">
          At PrepPal, we're on a mission to simplify meal planning and preparation for everyone. 
          We believe that eating well shouldn't be complicated or time-consuming. Our AI-powered 
          platform takes the stress out of meal prep by generating personalized meal plans that 
          fit your dietary preferences, time constraints, and cooking skill level.
        </p>
        <p className="text-gray-600">
          Whether you're a busy professional, a parent juggling family meals, or someone just 
          looking to eat healthier, PrepPal is designed to make your life easier and your meals 
          more delicious.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              Input your dietary preferences, allergies, available cooking time, and other constraints.
            </p>
          </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <p className="text-gray-600 mb-6">
          PrepPal was founded by a team of food enthusiasts, technology experts, and health-conscious 
          individuals who understand the challenges of consistent meal planning. We're committed to 
          continually improving our platform based on user feedback and nutritional science.
        </p>
        
        <div className="flex justify-center">
          <button className="btn btn-primary" onClick={() => document.dispatchEvent(new CustomEvent('openFeedbackModal'))}>
