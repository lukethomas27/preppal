          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                />
                <span className="text-gray-800 font-semibold">PrepPal</span>
              </div>
              <p className="text-sm text-gray-600">
                Your AI-powered meal prep assistant that simplifies planning, 
                cooking, and eating healthy for busy individuals and families.
              </p>
            </div>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <button 
                      ...
                      className="text-sm text-gray-600 hover:text-primary-600 bg-transparent p-0"
                    >
                      Send Feedback
                    </button>
                  </li>
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-800 mb-4">Subscribe</h3>
              <p className="text-sm text-gray-600 mb-4">
                Stay updated with our latest features and meal planning tips.
              </p>
              <div className="flex">
                <input
                  type="email"
                ...
                />
                <button className="bg-primary-600 text-white text-sm px-4 py-2 rounded-r-md hover:bg-primary-700">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div className="border-t border-gray-100 pt-6">
            <div className="flex flex-col sm:flex-row justify-between items-center">
              <p className="text-sm text-gray-600 mb-4 sm:mb-0">
                &copy; {currentYear} PrepPal. All rights reserved.
              </p>
